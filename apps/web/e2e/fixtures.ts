    ...
    symbols: [
      {
        ...
        kind: "group",
        umlType: "package",
        childViewId: "view:process-stage:inputs",
        doc: { summary: "Eingangsquellen und geladene Quelldaten." },
      },
      {
      ...
      },
      {
        ...
        label: "User",
        kind: "external",
        location: { file: "src/ui.py", startLine: 3, endLine: 28 },
        doc: { summary: "Startet den Ablauf manuell." },
      },
      {
        id: "ext:kafka",
        label: "Apache Kafka",
        ...
        doc: { summary: "Verteilt Meldungen an nachgelagerte Systeme." },
      },
      {
        id: "ext:audit-store",
        label: "Audit Store",
        kind: "external",
        umlType: "database",
        location: { file: "src/adapters/audit_store.py", startLine: 5, endLine: 49 },
        doc: { summary: "Persistiert die erzeugten Laufdaten." },
      },
    ],
    relations: [
      {
        id: "rel:overview-inputs-transform",
        type: "calls",
      ...
      },
      {
        ...
        type: "calls",
        source: "ext:user",
        target: "class:pipeline-controller",
        label: "start workflow",
        confidence: 1,
        evidence: [{ file: "src/ui.py", startLine: 12, endLine: 14, snippet: "controller.run(payload)" }],
      },
      {
        id: "rel:controller-load",
        type: "calls",
        source: "class:pipeline-controller",
        target: "class:repository",
        label: "load data",
        confidence: 1,
        evidence: [{ file: "src/pipeline_controller.py", startLine: 24, endLine: 25, snippet: "repository.fetch()" }],
      },
      {
        id: "rel:controller-build",
        type: "calls",
        source: "class:pipeline-controller",
        target: "class:schedule-builder",
        label: "build schedule",
        confidence: 1,
        evidence: [{ file: "src/pipeline_controller.py", startLine: 28, endLine: 28, snippet: "builder.build()" }],
      },
      {
        id: "rel:controller-publish",
        type: "writes",
        source: "class:pipeline-controller",
        target: "ext:kafka",
        label: "publish schedule",
        confidence: 1,
        evidence: [{ file: "src/pipeline_controller.py", startLine: 31, endLine: 31, snippet: "kafka.publish(schedule)" }],
      },
      {
        id: "rel:repository-audit",
        type: "reads",
        source: "class:repository",
        target: "ext:audit-store",
        label: "load audit trail",
        confidence: 1,
        evidence: [{ file: "src/repository.py", startLine: 11, endLine: 12, snippet: "audit_store.load()" }],
      },
    ],
    views: [
      {
        ...
        nodeRefs: ["proc:pkg:inputs", "proc:pkg:transform"],
        edgeRefs: ["rel:overview-inputs-transform"],
      },
      {
